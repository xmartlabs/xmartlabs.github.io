...
author_id: remer
markdown: redcarpet
description: In this occasion we will introduce a way to create a client side JavaScript plug-in that can be easily integrated in any third party websites.
