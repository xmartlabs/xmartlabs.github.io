...
For this the team paired a ultrasonic sensor with an ESP8266 chip and also developed a custom command for Slack to give orders to the chip. 
...
Although currently it's only working for desktop PC's, the team is already planning on making a port for Android or iOS.
...
<img width="100%" src="/images/xmartlabs-first-hackathon/parrilla_overview.jpg" /> 
<br />
